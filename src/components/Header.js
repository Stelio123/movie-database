                    ...
                    <Link to= '/'><svg xmlns="http://www.w3.org/2000/svg" width="106.916" height="48" viewBox="0 0 106.916 48">
                        <g id="logo" transform="translate(-45 -3)">
                            <text id="SNOS_MOVIES" data-name="SNOS
                                MOVIES" transform="translate(46 27)" fill="#fff" stroke="#0f0b34" stroke-width="1" font-size="24" font-family="HelveticaNeue-Bold, Helvetica Neue" font-weight="700"><tspan x="0" y="0">SNOS</tspan><tspan x="0" y="18">MOVIES</tspan></text>
